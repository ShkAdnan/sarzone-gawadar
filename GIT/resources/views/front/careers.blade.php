            ...
            <tbody>
                ...
                @foreach ($careers as $career)
                    ...
                    <tr>
                        ...
                        <td>{!! $career->job_requirements !!}</td>

                        <td>{{ $career->job_endDate }}</td>

                        <td><a href="{{url('alumnae/applyForm/'.$career->job_id.'/careers_job')}}" class="btn btn-primary">Apply Now</a></td>
                        {{-- <td align="center">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Apply For Careers</h5>
                                        ...
                                        <div class="modal-body">
                                            <p>
                                                ...
                                                <form method="POST" action="{{route('careers.apply')}}" enctype="multipart/form-data" class="pt-5">
                                                    @csrf
                                                    <input class="form-control" type="hidden" name="jobId" value="{{$career->job_id}}">
