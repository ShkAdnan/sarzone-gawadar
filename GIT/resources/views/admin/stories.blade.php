    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 mx-auto mt-5" style="margin-top: 50px;">
                ...
                <form class="form" action="{{route('Stories.add')}}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title_name" id="album_title" class="form-control" placeholder="" aria-describedby="helpId">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="album_title" class="form-control" placeholder="" aria-describedby="helpId">
